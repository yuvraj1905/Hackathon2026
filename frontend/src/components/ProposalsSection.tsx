    ...
    return (
      <div className="card-spotlight rounded-2xl p-12 text-center flex flex-col items-center justify-center gap-4">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                        ...
                        {p.totalHours > 0 && (
                          <span>{fmtNum(p.totalHours)} hrs</span>
                        )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="ml-auto flex shrink-0 items-center gap-2">
                    <Button
                      ...
                      disabled={!requestId}
                      onClick={() =>
                        window.open(`/proposal/pdf/${requestId}`, "_blank")
                      }
        ...
        <p className="text-sm text-muted-foreground max-w-md">
          No proposals yet. Start by generating a new proposal from your project
          idea.
        </p>
      ...
      {proposalData && (
        <>
          ...
          {proposalData.abstract && (
            <div className="card-accent card-accent-primary p-5">
              <div className="mb-3 flex items-center gap-2.5">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary/12">
                  <BookOpen className="h-4 w-4 text-primary" />
                </div>
                <h3 className="text-sm font-bold">Abstract</h3>
              </div>
              <p className="text-xs leading-relaxed text-muted-foreground">
                {proposalData.abstract}
              </p>
          ...
          {proposalData.clientDependencies &&
            proposalData.clientDependencies.length > 0 && (
              <div className="card-accent card-accent-warning p-5">
                <div className="mb-3 flex items-center gap-2.5">
                  <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-orange-500/12">
                    <Link2 className="h-4 w-4 text-orange-400" />
                  </div>
                  <h3 className="text-sm font-bold">Client Dependencies</h3>
                </div>
                <ul className="space-y-1.5">
                  {proposalData.clientDependencies.map((dep, i) => (
                    <li
                      key={i}
                      className="flex items-start gap-2 text-xs text-muted-foreground"
                    >
