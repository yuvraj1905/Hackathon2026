...
export default function HomePage() {
  return (
    <div className="min-h-screen overflow-x-hidden bg-background">
      ...
      <nav className="sticky top-0 z-40 bg-background/70 backdrop-blur-xl border-b border-border/40">
        <div className="container mx-auto flex items-center justify-between h-14 px-4">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            <span className="font-display text-lg font-bold tracking-tight">Neural Architects</span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <ThemeToggle inline className="h-8 w-8 border-border/40 hover:bg-primary/5" />
            <Link href="/login">
      ...
      <section className="relative overflow-hidden pt-16 pb-20 dot-grid">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div className="max-w-4xl mx-auto text-center" initial="hidden" animate="visible">
            {/* Badge */}
            <motion.div variants={fadeUp} custom={0} className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/20 bg-primary/8 text-primary text-xs font-medium mb-5 backdrop-blur-sm">
            ...
            {/* Headline */}
            <motion.h1 variants={fadeUp} custom={1} className="text-4xl md:text-5xl lg:text-6xl font-display font-bold tracking-tight leading-[1.08] mb-4">
            ...
            <motion.p variants={fadeUp} custom={2} className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-6 leading-relaxed">
            ...
            <motion.div variants={fadeUp} custom={3} className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link href="/login">
                <Button size="lg" className="btn-glow text-white text-sm px-6 h-10 rounded-xl">
            ...
            <motion.div variants={fadeUp} custom={4} className="mt-6 flex items-center justify-center gap-3 text-xs text-muted-foreground">
      ...
      <section id="how-it-works" className="relative py-12">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm max-w-xl mx-auto">Four simple steps from raw idea to polished proposal</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-4 max-w-5xl mx-auto relative">
            ...
            {steps.map((step, i) => (
              ...
              >
                <div className={`w-10 h-10 rounded-lg gradient-bg flex items-center justify-center mx-auto mb-3 shadow-md shadow-primary/25 group-hover:shadow-primary/40 group-hover:scale-110 transition-all duration-300`}>
      ...
      <section id="features" className="py-14 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-xs font-semibold uppercase tracking-widest text-accent mb-2">What&apos;s included</p>
            <h2 className="text-2xl md:text-3xl font-display font-bold mb-2">Powerful Features</h2>
            <p className="text-muted-foreground text-sm max-w-xl mx-auto">Everything you need to create accurate, professional proposals</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-5xl mx-auto">
            {features.map((f, i) => (
              ...
              >
                ...
                <h3 className="font-display font-semibold text-sm mb-1 group-hover:text-primary transition-colors">{f.title}</h3>
      ...
      {/* Stats */}
      <section id="stats" className="relative overflow-hidden py-12">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <p className="text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-2">By the numbers</p>
            <h2 className="text-2xl md:text-3xl font-display font-bold">Trusted by teams worldwide</h2>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {stats.map((s, i) => (
              <motion.div
                key={s.label}
                className="glass-card p-4 text-center rounded-xl border border-border/40 group hover:border-primary/30 transition-all duration-300"
              ...
              >
                <div className={`text-2xl md:text-3xl font-display font-bold bg-gradient-to-r ${s.color} bg-clip-text text-transparent mb-1`}>
                  {s.value}
                </div>
          ...
          >
            <div className="relative p-6 md:p-8 rounded-2xl border border-primary/20 bg-card/60 backdrop-blur-xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <Link href="/signup">
                  <Button size="lg" className="btn-glow text-white px-8 h-10 text-sm rounded-xl">
